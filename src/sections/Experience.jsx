    ...
    return (
      <div className="relative flex-1 flex justify-center items-center min-w-0" key={`${exp.company}-${exp.role}-${idx}`}>
        ...
        >
          ...
          <p className="text-md text-gray-300 wrap-break-wordword">{exp.description}</p>
        </motion.article>
      </div>
    );
  }
  ...
  return (
    <div key={`${exp.company}-${exp.role}-m-${idx}`} className="relative flex items-start">
      ...
      >
        ...
        <p className="text-sm text-gray-400 mb-2 wrap-break-wordword">{exp.company} | {exp.duration}</p>
        <p className="text-sm text-gray-300 wrap-break-wordword">{exp.description}</p>
      </motion.article>
    </div>
  );
}
        ...
        <div className="sticky top-0 h-screen flex flex-col">
          ...
          <div className="flex-1 flex items-center justify-center px-6 pb-10">
            ...
            <div className="relative w-full max-w-7xl hidden md:block">
              ...
              <div className="relative h-1.5g-white/15 rounded">
