        ...
        >
          ...
          <div className="flex-1 flex flex-col justify-center text-center md:text-left">
            ...
            <p className="mt-4 text-gray-300 leading-relaxed text-base sm:text-lg max-w-2xl md:max-w-3xl">
              ...
              Intelligence and Machine Learning. I enjoy building modern applications,
              exploring AI technologies, solving problems with code, and turning ideas
              into practical projects with clean and user-friendly interfaces.
            </p>

            {/* Quick stats */}
            <div className="mt-6 grid grid-cols-2 sm:grid-cols-3 gap-3 sm:gap-4 max-w-xl">
              {[
                { label: "Education", value: <>B.Tech CSE <br />( AI & ML )</> },
                { label: "Year", value: <> 2nd Year <br />( 3rd Semester )</> },
                { label: "University", value: "Adamas University" },
              ].map((item, i) => (
                <motion.div
                  key={i}
        ...
        <div className="grid md:grid-cols-1">
          ...
          >
            ...
            <p className="text-gray-300 leading-relaxed text-base sm:text-lg">
              I’m Sayanjit Jana, a 2nd Year B.Tech CSE (AI & ML) student at Adamas University, passionate about programming, web development, and artificial intelligence.
            </p>

            <p className="mt-4 text-gray-400 text-base sm:text-lg">
              I enjoy learning new technologies, building projects, and turning ideas into practical digital solutions.
            </p>
          </motion.div>
        </div>
      </div>
